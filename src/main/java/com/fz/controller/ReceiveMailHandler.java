...
public class ReceiveMailHandler {
    ...
    public static String MAIL_HOST = "pop.qq.com";//服务器ip

    public static int MAIL_PORT = 995;//端口
    ...
    public void receiveMail(String userName,String passWord) {
        ...
        try{
            //进行用户邮箱连接
            urln = new URLName("pop3", "pop.qq.com",995, null,userName,passWord);
            ...
            if(messageCount > 0){
                ...
                for(int i = 0;i < messages.length;i++) {
                    ...
                    if (isContainAttach((Part)messages[i])) {
                        saveAttachMent((Part)messages[i],"upload/recMail/");
                    }
    ...
    public static void main(String[] args) {
        try {
            new ReceiveMailHandler().receiveMail("275300091@qq.com", "zwrdfwntpketbjeh");
        } catch (Exception e) {
