...
<script type="text/javascript" src="<%=path%>/js/plugins/datapicker/bootstrap-datetimepicker.min.js"></script>
<script type="text/javascript" src="<%=path%>/js/plugins/datapicker/locales/bootstrap-datetimepicker.zh-CN.js"></script>
</html>
