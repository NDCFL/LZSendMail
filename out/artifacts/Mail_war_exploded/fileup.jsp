...
<head>
    ...
    <link href="<%=path%>/css/webuploader/0.1.5/webuploader.css" rel="stylesheet" type="text/css" />
</head>
<body>
<div class="page-container">
    <form class="form form-horizontal" onsubmit="return checkimg();" id="form-article-add" method="post" action="<%=path%>/lpimg/addloupanimg">
        <div class="row cl">
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="<%=path %>/css/webuploader/0.1.5/webuploader.min.js"></script>
