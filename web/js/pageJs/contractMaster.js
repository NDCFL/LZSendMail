    ...
    columns:[
        ...
        ,
        {
            ...
            formatter: function (value, row, index) {
                ...
                var g = '<a title="签约列表" class="J_menuItem"  target="_blank"  href="/contract/contractByMasterListPage/'+row.id+'\"><i class="glyphicon glyphicon-th-list" alt="签约列表" style="color:green"></i></a> ';
                return e+d+f+g;
            }
        }
    ],
